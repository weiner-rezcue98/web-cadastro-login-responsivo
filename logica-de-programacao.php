...
// Recupere informações do usuário, incluindo o curso
$stmt = $con->prepare("SELECT useremail, userimage, username, usercourse, userwhatsapp, user_matricula FROM usuarios WHERE id = ?");
$stmt->bind_param("i", $user_id);
$stmt->execute();
$stmt->bind_result($useremail, $userimage, $username, $usercourse, $userwhatsapp, $user_matricula);
$stmt->fetch();
$stmt->close();

// Recupere informações do curso com base no ID do curso do usuário
$stmt = $con->prepare("SELECT course_name, course_description, curso_turma FROM courses WHERE course_id = ?");
$stmt->bind_param("i", $usercourse); // Supondo que o ID do curso do usuário esteja armazenado em 'usercourse'
$stmt->execute();
$stmt->bind_result($course_name, $course_description, $curso_turma);
$stmt->fetch();
$stmt->close();
?>
                            ...
                            <div class="col-xl-4">
                                <div class="card overflow-hidden">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-sm-4">
                                            <img id="profile-image" src="<?php echo $userimage; ?>" alt="Perfil do Usuário" class="img-thumbnail rounded-circle" style="max-width: 60px;">

                                            </div>
                                            <h5 class="font-size-15 text-truncate"><?php echo $username; ?></h5>
                                            <p class="text-muted mb-0 text-truncate"><?php echo $course_description; ?></p>
                                            </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="pt-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <h5 class="font-size-15">Matrícula</h5>
                                                            <p class="text-muted mb-0"><?php echo $user_matricula; ?></p>
                                                        </div>
                                                        <div class="col-6">
                                                            <h5 class="font-size-15">Turma</h5>
                                                            <p class="text-muted mb-0"><?php echo $curso_turma; ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="mt-4">
    <a href="javascript:void(0);" class="btn btn-primary waves-effect waves-light btn-sm" onclick="openProfileEditor()">Atualizar perfil <i class="mdi mdi-arrow-right ms-1"></i></a>
</div>
                            ...
                            <form class="form-label" action="atualizar-perfil.php" method="post" enctype="multipart/form-data">
                                <div class="avatar-md mx-auto mb-4">
                                    <div class="avatar-title bg-light rounded-circle text-primary h1">
                                        <img id="profile-image" src="<?php echo $userimage; ?>" alt="" class="img-thumbnail rounded-circle" style="max-width: 100px; max-height: 100px;">
                                    </div>
...
<!-- POP-UP-->
        ...
        <h3>Bem-vindo ao nosso curso!</h3>
        <p>Por favor, mantenha seus dados de perfil atualizados e não deixe nenhum campo em branco.</p>
    </div>
