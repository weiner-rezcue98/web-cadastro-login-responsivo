...
$stmt = $con->prepare("SELECT course_name, course_description FROM courses WHERE course_id = ?");
...
<!--
        ...
        <div id="popup" class="popup">
            ...
            <p>Lembre-se de preencher todos os campos obrigatórios.</p>
        ...
        <script>
            ...
            // Mostre o pop-up após o login (pode ser adicionado à página do curso)
            mostrarPopup();
        </script>
-->
        <!-- Google reCAPTCHA -->
